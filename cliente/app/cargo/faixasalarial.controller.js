(function () {
    'use strict';
    angular.module('app').controller('FaixaSalarialController', ['FaixaSalarial', '$state', 'Workspace', '$q', FaixaSalarialController]);

	var state = "faixasalarial"
	
    function FaixaSalarialController(FaixaSalarial, $state, Workspace, $q) {
        var vm = this;
        ...
        vm.list = []
        vm.selectedItems = []
        Workspace.title = "Faixa Salarial"
        ...
        function load(query) {
            vm.promise = FaixaSalarial.query(query, success).$promise;
            loadCount()
        ...
        function loadCount() {
            FaixaSalarial.count(vm.query).$promise.then(function (e) {
                vm.count = e.count
            });
