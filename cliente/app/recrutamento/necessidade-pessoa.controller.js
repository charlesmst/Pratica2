(function () {
    'use strict';
    angular.module('app').controller('NecessidadePessoaController', ['NecessidadePessoa', '$state', 'Workspace', '$q', NecessidadePessoaController]);

    var state = "necessidade-pessoa"

    function NecessidadePessoaController(NecessidadePessoa, $state, Workspace, $q) {
        var vm = this;
